...
<html>
    <head>
        ...
        <script>
            function checku() {
                if (document.getElementById("cname").textContent == null || document.getElementById("cname").textContent == "") {
                    alert("Please Login or Signup before order something! Thank you");
                    return false;
                }
                else
                    return true;
    ...
    <body>
                    ...
                    <form action="search" method="POST">
                        ...
                        <div class="dropdown">
                            ...
                            <div class="dropdown-content">
                                ...
                                <a href="cart?page=logout&action=project&id=0" style="z-index: 4; font-size: 20px">Log out</a>
                            </div>
                        </div>
        ...
        <div style="background-color: #D9A056">
            ...
            <br><br><br>
            <h1 style="text-align: center; font-size: 50px;">Your Cart </h1>
            <table>
                <col width="10%">
                <col width="20%">
                <col width="25%">
                ...
                <tr>
                    ...
                    <td><div class="">                                                   
                            <a href="cart?page=remove&action=showCart&id=<%=x.getP_id()%>" style="text-decoration: none; color: black; font-size: 50px; "><b>   -   </b></a>&nbsp;
                            <input class="cart_quantity_input" type="number" value="<%=x.getQuantity()%>" disabled="disabled" style="width: 35px; text-align: center; background-color: #D9A056; border: none; font-size: 30px; font-family: Amatic SC; font-weight: bold; color: black;">
                            <a href="cart?page=addtocart&action=showCart&id=<%=x.getP_id()%>" style="text-decoration: none; color: black; font-size: 50px; "><b>   +   </b></a>                                                			
                        </div></td>
            ...
            <br>
            <center>
                <a onclick="return checku()" href="customer_pay.jsp" style="text-decoration: none"><input type="submit" value="PAY" id="submit1" style="font-family: Amatic SC; font-size: 28px"></a>
            </center>
            <br>    
