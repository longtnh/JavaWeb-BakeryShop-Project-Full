...
<html>
    ...
    <body>
        ...
        <div style="background-color: #D9A056">
            <br><br>
            <center>
                <h3 style="font-size : 50px">Feedback</h3>
                <div class="container3">
                    <form action="addFeedback" method="Post" onsubmit="return check()">
                        <div class="div-info">
                            <div class="div-right">
                                <label for="fname"  style="font-size : 32px"><b>First Name</b></label>
                                <br>
                                <input type="text" id="fname" name="firstname" placeholder="Your first name.." required>
                                <br>
                                <label for="lname"  style="font-size : 32px"><b>Last Name</b></label>
                                <br>
                                <input type="text" id="lname" name="lastname" placeholder="Your last name.." required>
                                <br>			
                                <label for="email"  style="font-size : 32px"><b>Email</b></label>
                                <br>
                                <input type="text" id="email" name="email" placeholder="Your Email ..." required>
                                <br>
                            </div>
                            <div class="div-left">
                                <img src="./image/avatar.jpg" height="300px" width="300px" style="float:left">
                            </div>
                        </div>
                        <label for="subject"  style="font-size : 32px"><b>Your Feedback</b></label>
                        <br>
                        ...
                        <br>
                        <input type="submit" value="Submit" id="submit1" style="font-family: Amatic SC; font-size: 24px">
                    </form>
                    ...
                    <script type="text/javascript">
                        function check() {
                            ...
                            if (!js_email.test(document.getElementById('email').value)) {
                                alert("Your Email is not valid");
                                return false;
                            }
                            else if (!document.getElementById('star-5').checked && !document.getElementById('star-4').checked
                                    && !document.getElementById('star-3').checked && !document.getElementById('star-2').checked
                                    && !document.getElementById('star-1').checked) {
                                alert("Please rate by star !");
                                return false;
                            }
                            else {
                                alert("Thanks for your feedback ! Hope that you will comeback!")
                                return true;
                            }
                        }
                    </script>
